                ...
                script {
                    ...
                    '''#!/bin/bash -l
                        ...
                        for i in *; do
                            ...
                            curl -L -u 320049003:AP8vGdZe9YmJVf1t3np14Pai7hn -X PUT "${ARTIFACTORYUPLOADURL}" -T $i
                        done
                        echo "Upload ended"
                        cd -
...
def publishAPIDocs() {
    ...
    def shellcommand = '''#!/bin/bash -l
        ...
        curl -L -u 320049003:AP8vGdZe9YmJVf1t3np14Pai7hn -X PUT "'''+artifactoryBasePath+'''"/API_DOCS/ -T $API_DOC_ZIP
    '''
    echo shellcommand
    sh shellcommand
}
