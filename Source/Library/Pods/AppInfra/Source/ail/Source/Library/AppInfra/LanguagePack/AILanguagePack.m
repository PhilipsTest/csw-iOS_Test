...
-(void)downloadOverviewFileforServiceId:(NSString*)serviceId
    ...
    [self.aiAppInfra.serviceDiscovery getServiceUrlWithCountryPreference:serviceId
                                                   withCompletionHandler:^(NSString *serviceURL, NSError *error) {
                                                       [AIInternalLogger log:AILogLevelDebug
                                                                     eventId:kLanguagePackEventID
                                                                     message:serviceURL];
                                                       if (serviceURL && !error) {
                                                           [self.RESTClient GET:serviceURL
                                                                     parameters:nil
                                                                       progress:nil
